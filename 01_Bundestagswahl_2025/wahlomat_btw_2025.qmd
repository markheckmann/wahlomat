...
ga_2d <- reorder2d(ga)
e_ii <- c(3:11, 1:2) # rotieren links - rechts
bertin(ga_2d[, e_ii],
  align = FALSE,
  colors = c("red", "green"),
  showvalues = FALSE,
...
```{r img-biplot, echo=FALSE, fig.width = 7, fig.height=7}
...
thesen_ordered <- stri_sort(df$these_titel, locale = "de_DE")
de_order <- match(df$these_titel, thesen_ordered)
df |>
